...
public class ServletContextClass implements ServletContextListener {
	...
	private static String htmlPath = "F:\\Study\\MAC\\ACC_Project\\ACC_WebSearchEngine\\FinalSearchTest - Copy\\HTML_Files\\";
	private static String textPath = "F:\\Study\\MAC\\ACC_Project\\ACC_WebSearchEngine\\FinalSearchTest - Copy\\Text_Files\\";
	...
	public static String[] generateKeyword(String keyword) {
		...
		try {
			reader = new BufferedReader(new FileReader("F:\\Study\\MAC\\ACC_Project\\ACC_WebSearchEngine\\FinalSearchTest - Copy\\stopWords.txt"));
